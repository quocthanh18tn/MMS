...
<br>
  		<p id="p1">Edit Customer </p>
		

		<div class="container-fluid">
			<div class="row">
				<div class="col-sm-6">
	                <form method="post" action="project/adjustcustomer.html/<?php echo e($customer->id); ?>" >
				      <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
	                      <p id="p2"> Customer Information </p>
		                        ...
		                        <div class="row">
			                      	...
			                      	<div class="col-sm-8">
			                          <input type ="text" name="id"   value="<?php echo e($customer->idCustomer); ?>" > 
