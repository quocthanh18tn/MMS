  			...
  			<table class="table table-striped table-bordered table-hover" id="dataTables-example">
                ...
                <tbody>
                    ...
                    <tr class="odd gradeX" align="center">
                        <td><?php echo e($pro->idProject); ?></td>
                        <td><?php echo e($pro->name); ?></td>
                       <td class="center"><i class="fa fa-trash-o  fa-fw"></i><a   onclick="return confirm('Are you sure you want to Delete?');" href="project/deleteproject.html/<?php echo e($pro->id); ?>"> Delete</a></td>
                        <td class="center"><i class="fa fa-pencil fa-fw"></i> <a href="project/adjustproject.html/<?php echo e($pro->id); ?>">Edit</a></td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </tbody>
        	</table>
          <div style="text-align: center;">
                    <?php echo e($project->appends(request()->input())->links()); ?>
