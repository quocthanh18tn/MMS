...
<div class="modal1 animate" id="id01" style="background-color: #ffffcc">
    ...
    <div>
      ...
      <input type="text" value="{{$panel->first()->projects->idProject}}" style="font-weight: bold;
                        font-size: 17px;
      ...
      <input type="text" value='{{$customer->name."-".$customer->phone."-".$customer->idCustomer}}' readonly style="font-weight: bold;
                        font-size: 17px;
                        background-color: #A0A0A0;
                        border-radius: 12px;
                        height: 50px;
      ...
      <input type="text" value="{{$order}}" readonly style="font-weight: bold;
                        font-size: 17px;
                        background-color: #A0A0A0;
                        border-radius: 12px;
                        height: 50px;
